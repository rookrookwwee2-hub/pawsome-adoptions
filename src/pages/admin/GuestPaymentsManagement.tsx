...
const GuestPaymentsManagement = () => {
  ...
  const [selectedPayment, setSelectedPayment] = useState<GuestPayment | null>(
    null
  );
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage USDT cryptocurrency payments from guests
          </p>
        </div>
        ...
        >
          <DialogContent className="sm:max-w-lg">
            <DialogHeader>
              ...
              <DialogDescription>
                Review the USDT payment details
              </DialogDescription>
            </DialogHeader>
                ...
                {selectedPayment.transaction_hash && (
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <a
                        href={`https://tronscan.org/#/transaction/${selectedPayment.transaction_hash}`}
                        target="_blank"
