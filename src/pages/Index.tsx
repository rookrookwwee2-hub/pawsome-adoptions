...
const Index = () => {
  return (
    <>
      <Helmet>
        <title>Pawsfam - Find Your Perfect Pet Companion</title>
        <meta
          name="description"
          content="Adopt your new best friend from Pawsfam. Browse thousands of dogs, cats, and other pets looking for loving homes. Start your adoption journey today."
        />
        <meta property="og:title" content="Pawsfam - Pet Adoption Platform" />
        <meta
