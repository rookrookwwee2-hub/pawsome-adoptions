...
const About = () => {
  ...
  const stats = [
    { icon: Globe, value: "3,000+", label: t("about.statPartners") },
    { icon: Users, value: "93+", label: t("about.statCountries") },
    { icon: Heart, value: "10,000+", label: t("about.statFamilies") },
    { icon: Truck, value: "24/7", label: t("about.statSupport") },
  ];
